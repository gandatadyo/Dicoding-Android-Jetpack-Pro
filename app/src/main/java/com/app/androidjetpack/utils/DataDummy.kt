...
object DataDummy {
    fun generateDummyCourses(): ArrayList<MovieEntity> {

        val courses = ArrayList<MovieEntity>()

        courses.add(MovieEntity("a14",
