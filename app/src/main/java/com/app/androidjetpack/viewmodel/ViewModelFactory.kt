...
import com.app.androidjetpack.ui.detail.DetailDataViewModel
...
class ViewModelFactory private constructor(private val myRepository: MyRepository) : ViewModelProvider.NewInstanceFactory() {
    ...
    override fun <T : ViewModel> create(modelClass: Class<T>): T {
        return when {
            ...
            modelClass.isAssignableFrom(DetailDataViewModel::class.java) -> {
                DetailDataViewModel(myRepository) as T
            }
